...
def main():
    ...
    st.write("Afim de continuar esse progresso, análises foram montadas para evidenciar quais serão os próximos passos dentro do comércio de vinho")
    # Texto removido -> 
...
st.write("Trabalhamos com uma base de 124 paises com os valores anuais de exportação em litros e valor monetário (US$) e com isso descobrimos análises que indicam onde os recursos devem ser alocados para a contínua geração de renda.")
st.write("Na base abaixo, podemos conferir o consolidado das informações nos últimos 15 anos de cada país")
...
with tab1:
    ...
    st.write("Com o objetivo de entender como poderiamos definir os escopos dos consumidores, criamos uma categorização por nível socioeconômico desses principais exportados:")
